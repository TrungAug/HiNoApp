...
//    }
    ...
    boolean checkNull() {
        ...
        if (maHienTai == null || maHienTai.equalsIgnoreCase("")) {
            ...
            return false;
        } else if (passHienTai == null || passHienTai.equalsIgnoreCase("")) {
            DialogHelper.alert(this, "Vui lòng nhập mật khẩu hiện tại");
            return false;
        } else if (passMoi == null || passMoi.equalsIgnoreCase("")) {
            DialogHelper.alert(this, "Vui lòng nhập mật khẩu moi");
            return false;
        } else if (passMoi.length() < 8) {
            DialogHelper.alert(this, "Mật khẩu phải có ít nhất 8 ký tự");
            return false;
        } else if (!passMoi.equalsIgnoreCase(xacNhanPassMoi)) {
            DialogHelper.alert(this, "Xác nhận mật khẩu không đúng");
            return false;
        } else if (!maNvCu.equalsIgnoreCase(maHienTai) || !passNvCu.equalsIgnoreCase(passHienTai)) {
    ...
    private void initComponents() {
        ...
        btnXacNhan.setBackground(new java.awt.Color(102, 102, 102));
        ...
        txtXacNhanPassMoi.setText("matkhau");
    ...
    private void txtPassMoiFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPassMoiFocusGained
       if (new String(txtPassMoi.getPassword()).equalsIgnoreCase("matkhau")) {
           txtPassMoi.setText("");
        }
    ...
    private void txtXacNhanPassMoiFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtXacNhanPassMoiFocusGained
        if (new String(txtXacNhanPassMoi.getPassword()).equalsIgnoreCase("matkhau")) {
