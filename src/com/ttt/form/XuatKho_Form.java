...
public final class XuatKho_Form extends Form {
    ...
    boolean checkNull() {
        ...
        try {
            ...
            if (txtGiaXuat.getText() == null || txtGiaXuat.getText().equalsIgnoreCase("")) {
                DialogHelper.alert(this, "Vui lòng nhập giá xuất");
                return false;
            } else {
    ...
    void setForm(ChiTietPhieuNhap ct) {
        ...
        NhanVien nv2 = NhanVienDAO.getNewNhanVienDAO().selectById(ct.getMaNhanVienXuat());
        if (nv2 != null) {
    ...
    private void initComponents() {
        ...
        add(btnTimKiem);
        btnTimKiem.setBounds(17, 557, 70, 26);
        ...
        add(btnFirst);
        btnFirst.setBounds(281, 563, 31, 26);
        ...
        add(btnPrev);
        btnPrev.setBounds(330, 563, 36, 26);
        ...
        add(btnNext);
        btnNext.setBounds(384, 563, 36, 26);
        ...
        add(btnLast);
        btnLast.setBounds(438, 563, 31, 26);
        ...
        tblChiTiet.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Mã PX", "Vị trí", "Loại xe", "Số khung", "Số máy", "Số lượng Xuất", "Giá Xuất", "Người Xuất", "Ngày Xuất", "Người sửa", "Ngày sửa", "Mã KH", "Ma NVKD"
            }
        ) {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(6, 595, 774, 215);
        ...
        add(btnXuatFile);
        btnXuatFile.setBounds(690, 560, 70, 26);
        ...
        add(btnTimKiem2);
        btnTimKiem2.setBounds(620, 560, 63, 26);
        ...
        lblMaST11.setForeground(new java.awt.Color(255, 0, 51));
        ...
        panelBackground1.setBounds(400, 120, 380, 380);
        ...
        lblMaST3.setBounds(40, 50, 25, 18);
        ...
        btnPlusPXK.setBounds(340, 10, 32, 26);
        ...
        panelBackground2.setBounds(10, 120, 380, 380);
        ...
        add(txtTim);
        txtTim.setBounds(98, 540, 160, 40);
