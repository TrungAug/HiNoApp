...
public final class ViTri_Form extends Form {
    ...
    void lamMoi() {
        txtMavt.setText(ThongKeDAO.getNewThongKeDAO().getMaViTri());
        txtTenVt.setText("");
        txtTimKiem.setText("Nhập tên vị trí");
        this.row = -1;
        this.fillTable();
    }
    ...
    public void delete() {
        ...
        if (vt != null) {
            ...
            DialogHelper.alert(this, "Chưa có vị trí " + ma);
        }
    }
    ...
    private void initComponents() {
        ...
        add(btnTimKiem);
        btnTimKiem.setBounds(17, 324, 70, 26);
        ...
        add(btnFirst);
        btnFirst.setBounds(293, 324, 31, 26);
        ...
        add(btnPrev);
        btnPrev.setBounds(336, 324, 36, 26);
        ...
        add(btnNext);
        btnNext.setBounds(384, 324, 36, 26);
        ...
        add(btnLast);
        btnLast.setBounds(432, 324, 31, 26);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(17, 374, 796, 215);
        ...
        add(btnXuatFile);
        btnXuatFile.setBounds(734, 324, 70, 26);
        ...
        btnMoi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMoibtnOptionActionPerformed(evt);
            }
        });
        add(btnMoi);
        ...
        lbMaViTri.setForeground(new java.awt.Color(255, 0, 51));
        ...
        panelBackground2.setBounds(273, 77, 410, 210);
        ...
        add(txtTimKiem);
        txtTimKiem.setBounds(110, 310, 170, 40);
    ...
    private void btnMoibtnOptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMoibtnOptionActionPerformed
        String Option = evt.getActionCommand();
        String them = btnThem.getText();
        String sua = btnSua.getText();
        String xoa = btnXoa.getText();
    ...
    }//GEN-LAST:event_btnMoibtnOptionActionPerformed
    ...
    private void txtTimKiemFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTimKiemFocusGained
        if (txtTimKiem.getText().equalsIgnoreCase("Nhập tên vị trí")) {
            txtTimKiem.setText("");
        }
