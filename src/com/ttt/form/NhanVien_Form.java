...
//    public void chonAnh() {
//        JFileChooser fileChooser = new JFileChooser(".\\ImgNhanVien");
//        if (FileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
//            File file = FileChooser.getSelectedFile();
//            ShareHelper.save(file); // Lưu ình vào thư mục logos
//            ImageIcon icon = ShareHelper.read(file.getName());
//            Image image = icon.getImage();
//            Image scaleImage = image.getScaledInstance(160, 220, Image.SCALE_SMOOTH);
...
//    }
    ...
    public void setForm(NhanVien nv) {
        ...
        txtNgaysinh.setText(nv.getHoTen());
        txtNgaysinh.setText(nv.getDiaChi());
        txtNgaysinh.setText(nv.getEmail());
    ...
    public NhanVien getForm() {
        if (checkNull() && checkTrungEmail()) {
            ...
            nv.setHoTen(txtNgaysinh.getText());
            nv.setDiaChi(txtNgaysinh.getText());
            nv.setEmail(txtNgaysinh.getText());
            nv.setMatKhau(new String(txtMkx.getPassword()));
    ...
    void fillTableByKeyword() {
        ...
        try {
            ...
            List<NhanVien> list = NhanVienDAO.getNewNhanVienDAO().selectByKeyword(id);
            for (NhanVien nv : list) {
                Object[] rows = {
                    nv.getMaNV(), nv.getHoTen(), nv.getDiaChi(), nv.getEmail(), DateHelper.toStringFormat(nv.getNgaySinh(), "dd-MM-yyyy"), nv.getChucVu(), nv.getGioiTinh()
                };
                model.addRow(rows);
            }
        } catch (Exception e) {
    ...
    boolean checkNull() {
        ...
        String mk2 = new String(txtMkx.getPassword());
        String mk1 = new String(txtMkx.getPassword());
//        if(Auth.user==null){
//            DialogHelper.alert(this, "Vui lòng đăng nhập để thực hiện chức năng này");
//            return false;
//        }
        if (txtManv.getText().equals("") || txtManv.getText() == null) {
            DialogHelper.alert(this, "Vui lòng nhập mã nhân viên");
            return false;
        } else if (txtNgaysinh.getText() == null || txtNgaysinh.getText().equalsIgnoreCase("")) {
            DialogHelper.alert(this, "Vui lòng nhập tên người học");
            return false;
        } else if (!txtNgaysinh.getText().matches(patternName)) {
            DialogHelper.alert(this, "Họ tên người học không hợp lệ");
            return false;
        } else if (txtNgaysinh.getText() == null || txtNgaysinh.getText().equalsIgnoreCase("")) {
            DialogHelper.alert(this, "Vui lòng nhập ngày sinh");
            return false;
        } else if (!txtNgaysinh.getText().matches(patternDate) || txtNgaysinh.getText().equalsIgnoreCase("dd-MM-yyyy")) {
            DialogHelper.alert(this, "Vui lòng nhập ngày sinh theo định dạng dd-MM-yyyy");
            return false;
        } else if (txtNgaysinh.getText() == null || txtNgaysinh.getText().equalsIgnoreCase("")) {
            DialogHelper.alert(this, "Vui lòng nhập email");
            return false;
        } else if (rdoTruongPhong.isSelected() == false && rdoNhanVien.isSelected() == false && rdoAdmin.isSelected() == false) {
        ...
        //            return false;
        //        } 
        else if (checkTuoi < 18) {
            DialogHelper.alert(this, "Nhân viên phải lớn hơn 18 tuổi");
            return false;
        } else if (!mk1.matches(mk2)) {
    ...
    public boolean checkTrungEmail() {
        String checkEmail = txtNgaysinh.getText();
...
//        } else {
    ...
    private void initComponents() {
        ...
        btnTimKiem = new com.ttt.swing.Button();
        ...
        add(btnTimKiem);
        btnTimKiem.setBounds(17, 519, 70, 26);
        ...
        add(btnFirst);
        btnFirst.setBounds(281, 525, 31, 26);
        ...
        add(btnPrev);
        btnPrev.setBounds(330, 525, 36, 26);
        ...
        add(btnNext);
        btnNext.setBounds(384, 525, 36, 26);
        ...
        add(btnLast);
        btnLast.setBounds(438, 525, 31, 26);
        ...
        add(btnXuatFile);
        btnXuatFile.setBounds(720, 520, 70, 26);
        ...
        tblNhanVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã NV", "Tên NV", "Địa chỉ", "Email", "Ngày sinh", "Chức vụ", "Giới tính", "Hình"
            }
        ) {
        ...
        add(jScrollPane2);
        jScrollPane2.setBounds(20, 580, 780, 220);
        ...
        add(txtTimKiem);
        txtTimKiem.setBounds(100, 510, 170, 40);
    ...
    private void txtMkFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtMkFocusGained
        if (new String(txtMk.getPassword()).equalsIgnoreCase("matkhau")) {
            txtMk.setText("");
        }
    ...
    private void txtMkxFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtMkxFocusGained
        if (new String(txtMkx.getPassword()).equalsIgnoreCase("matkhau")) {
            txtMkx.setText("");
        }
    ...
    private void txtNgaysinhFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNgaysinhFocusGained
        if (txtNgaysinh.getText().equalsIgnoreCase("dd-MM-yyyy")) {
            txtNgaysinh.setText("");
        }
    ...
    private void txtTimKiemFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTimKiemFocusGained
        if (txtTimKiem.getText().equalsIgnoreCase("Nhập tên nhân viên")) {
            txtTimKiem.setText("");
        }
    ...
    private com.ttt.swing.Button btnTimKiem;
