...
public final class ChiNhanh_Form extends Form {
    ...
    boolean checkNull() {
        if (txtMaChiNhanh.getText().length() < 3 || txtMaChiNhanh.getText().length() > 7) {
            ...
            return false;
        } else if (txtTenChiNhanh.getText() == null || txtTenChiNhanh.getText().equalsIgnoreCase("")) {
            DialogHelper.alert(this, "Vui lòng nhập tên chi nhánh");
            return false;
        } else if (txtMaSoThue.getText().length() < 10 || txtMaSoThue.getText().length() > 14) {
    ...
    void lamMoi() {
        ...
        txtMaSoThue.setText("");
        txtDiaChi.setText("");
        txtTimKiem.setText("Nhập tên chi nhánh");
        this.row = -1;
        this.fillTable();
    }
    ...
    private void initComponents() {
        ...
        add(btnTimKiem);
        btnTimKiem.setBounds(20, 370, 70, 26);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(20, 420, 800, 215);
        ...
        add(txtTimKiem);
        txtTimKiem.setBounds(100, 360, 170, 40);
    ...
    private void txtTimKiemFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTimKiemFocusGained
        if (txtTimKiem.getText().equalsIgnoreCase("Nhập tên chi nhánh")) {
            txtTimKiem.setText("");
        }
