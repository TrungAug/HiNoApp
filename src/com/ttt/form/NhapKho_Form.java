...
public final class NhapKho_Form extends Form {
    ...
    void fillTable() {
        ...
        try {
            ...
            for (ChiTietPhieuNhap c : list) {
                Object[] rows = {c.getIdChiTietPhieuNhap(), c.getMaPhieuNhap(), c.getMaViTri(), c.getMaLoaiXe(), c.getSoKhung(), c.getSoMay(), c.getSoLuongNhap(), c.getGiaNhap(), c.getMaNhanVienNhap(), DateHelper.toStringFormat(c.getNgayNhap(),"dd-MM-yyyy"), c.getNguoiSuaPN(), DateHelper.toStringFormat(c.getNgaySuaPN(), "dd-MM-yyyy")};
                model.addRow(rows);
            }
        } catch (Exception e) {
    ...
    boolean isExist_SoKhung(String soKhung) {
        List<ChiTietPhieuNhap> list = ChiTietPhieuNhapDAO.getNewChiTietPhieuNhapDAO().selectAll();
        for (ChiTietPhieuNhap cd : list) {
            if (cd.getSoKhung().equals(soKhung)) {
                return true;
            }
    ...
    boolean isExist_PhieuNhap(String maPN) {
    ...
    boolean checkNull() {
        ...
        try {
            ...
            if (txtGiaNhap.getText() == null || txtGiaNhap.getText().equalsIgnoreCase("")) {
                DialogHelper.alert(this, "Vui lòng nhập giá");
                return false;
            } else {
    ...
    void themXeVaoPhieuNhap() {
        ...
        if (ct != null) {
            ...
            if (ct.getMaPhieuNhap().equals(check_ct)) {
                DialogHelper.alert(this, "Xe này đã nhập vào kho");
            } else {
    ...
    void suaPhieuNhap() {
        ...
        if (pn != null && ct != null && checkExistSoKhung()) {
    ...
    void xoa() {
        ...
        if (DialogHelper.confirm(this, "Bạn thực sự muốn xóa phiếu nhập ")) {
            try {
                List<ChiTietPhieuNhap> listPN = ChiTietPhieuNhapDAO.getNewChiTietPhieuNhapDAO().selectAll_MaPhieuNhap(txtPNK.getText());
    ...
    private void initComponents() {
        ...
        btnTimKiem2 = new com.ttt.swing.Button();
        ...
        add(btnTimKiem);
        btnTimKiem.setBounds(17, 516, 70, 26);
        ...
        add(btnFirst);
        btnFirst.setBounds(281, 522, 31, 26);
        ...
        add(btnPrev);
        btnPrev.setBounds(330, 522, 36, 26);
        ...
        add(btnNext);
        btnNext.setBounds(384, 522, 36, 26);
        ...
        add(btnLast);
        btnLast.setBounds(438, 522, 31, 26);
        ...
        tblChiTiet.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Mã PN", "Vị trí", "Loại xe", "Số khung", "Số máy", "Số lượng", "Giá", "Người nhập", "Ngày nhập", "Người sửa", "Ngày sửa"
            }
        ) {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(17, 571, 800, 215);
        ...
        add(btnXuatFile);
        btnXuatFile.setBounds(716, 527, 70, 26);

        btnTimKiem2.setBackground(new java.awt.Color(0, 51, 51));
        btnTimKiem2.setForeground(new java.awt.Color(255, 255, 255));
        btnTimKiem2.setText("In phiếu");
        add(btnTimKiem2);
        btnTimKiem2.setBounds(636, 527, 63, 26);
        ...
        txtDienGiai.setBounds(90, 240, 250, 80);
        ...
        panelBackground1.setBounds(420, 80, 380, 380);
        ...
        btnPlus.setBounds(330, 10, 32, 26);
        ...
        lblMaST9.setForeground(new java.awt.Color(255, 0, 51));
        ...
        panelBackground2.setBounds(30, 80, 380, 380);
        ...
        txtTim.setText("Nhập tên loại xe");
        ...
        add(txtTim);
        txtTim.setBounds(100, 510, 170, 40);
    ...
    private void txtTimFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTimFocusGained
        if (txtTim.getText().equalsIgnoreCase("Nhập tên loại xe")) {
            txtTim.setText("");
        }
    ...
    private com.ttt.swing.Button btnTimKiem2;
