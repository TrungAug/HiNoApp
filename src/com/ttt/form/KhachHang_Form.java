...
//        updateStatus();
    ...
    private void initComponents() {
        ...
        add(btnTimKiem);
        btnTimKiem.setBounds(20, 350, 70, 26);
        ...
        tblKhachHang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã KH", "Tên KH", "Địa chỉ", "Email", "Điện thoại", "MST"
            }
        ) {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(20, 400, 771, 215);
        ...
        txtTimKiem.setText("Nhập tên khách hàng");
        ...
        add(txtTimKiem);
        txtTimKiem.setBounds(100, 340, 170, 40);
    ...
    private void txtTimKiemFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTimKiemFocusGained
        if (txtTimKiem.getText().equalsIgnoreCase("Nhập tên khách hàng")) {
            txtTimKiem.setText("");
        }
